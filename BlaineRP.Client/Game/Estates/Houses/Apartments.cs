...
namespace BlaineRP.Client.Game.Estates
{
    public class Apartments : HouseBase
    {
        ...
        public Apartments(uint id, uint rootId, ushort floorIdx, ushort subIdx, int roomType, uint price, int @class, uint tax) : base(Core.HouseTypes.Apartments, id, price, roomType, @class, tax)
        {
            RootId = rootId;
