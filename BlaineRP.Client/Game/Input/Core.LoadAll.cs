    ...
    internal partial class Core
    {
        public static void LoadAll()
        {
            ...
            Add(new ExtraBind(BindTypes.DoorsLock,
                    ...
                    {
                        if (Utils.Misc.CanShowCEF(true, true))
                            Vehicles.Lock(null, Management.Interaction.CurrentEntity as Vehicle);
                    },
                    true,
                    true
                )
            ...
            Add(new ExtraBind(BindTypes.TrunkLook,
                    () =>
                    {
                        if (Utils.Misc.CanShowCEF(true, true) && Management.Interaction.CurrentEntity is Vehicle veh)
            ...
            Add(new ExtraBind(BindTypes.TakeItem,
                    () =>
                    {
                        if (Utils.Misc.CanShowCEF(true, true))
                        {
                            if (World.Core.ClosestItemOnGround == null)
                                return;

                            World.Core.ClosestItemOnGround.TakeItem();
                        }
                    },
                    true,
                    true
            ...
            Add(new ExtraBind(BindTypes.ReloadWeapon,
                    ...
                    {
                        if (Utils.Misc.CanShowCEF(true, true))
                            Management.Weapons.Core.ReloadWeapon();
                    },
                    true,
                    true
                )
            ...
            Add(new ExtraBind(BindTypes.TakeScreenshot,
                    () =>
                    {
                        UI.CEF.Phone.Apps.Camera.SavePicture(false, false, true);
                    },
                    true,
                    true
                )
            ...
            Add(new ExtraBind(BindTypes.EnterVehicle,
                    ...
                    {
                        if (Utils.Misc.CanShowCEF(true, true))
                            Vehicles.TryEnterVehicle(Management.Interaction.CurrentEntity as Vehicle, -1);
                    },
                    true,
                    false,
                    BindTypes.None,
