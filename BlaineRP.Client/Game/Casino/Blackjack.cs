    ...
    public class Blackjack
    {
                                    ...
                                    .Select(x =>
                                         {
                                             ...
                                             return new CardData()
                                             {
                                                 CardType = (CardTypes)byte.Parse(t[0]),
        ...
        public async System.Threading.Tasks.Task SpawnAllCards(string taskKey, AsyncTask task, List<CardData> dealerHand, List<List<CardData>> playersHands, byte alpha = 255)
        {
            ...
            for (var i = 0; i < dealerHand.Count; i++)
            {
                ...
                string objModelStr = GetCardModelByType(x.CardType == CardTypes.None ? CardTypes.Club_Ace : x.CardType);
        ...
        public static string GetCardModelByType(CardTypes cType)
        {
