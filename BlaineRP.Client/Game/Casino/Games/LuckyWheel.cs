    ...
    public class LuckyWheel
    {
        ...
        public LuckyWheel(int CasinoId, int Id, float PosX, float PosY, float PosZ, float Heading)
        {
            WheelObj = new MapObject(RAGE.Util.Joaat.Hash("vw_prop_vw_luckywheel_02a"),
                new Vector3(PosX, PosY, PosZ + 1.5f),
            ...
            BaseObj = new MapObject(RAGE.Util.Joaat.Hash("vw_prop_vw_luckywheel_01a"),
            ...
            ArrowObj = new MapObject(RAGE.Util.Joaat.Hash("vw_prop_vw_jackpot_on"),
                new Vector3(PosX, PosY, PosZ),
                new Vector3(0f, 0f, Heading),
                255,
                Settings.App.Static.MainDimension
            ...
            LightsObj = new MapObject(RAGE.Util.Joaat.Hash("vw_prop_vw_luckylight_on"),
                new Vector3(PosX, PosY, PosZ),
                new Vector3(0f, 0f, Heading),
                255,
                Settings.App.Static.MainDimension
            ...
            task = new AsyncTask(async () =>
                {
                    ...
                    Vector3 basePos = BaseObj.GetCoords(false);

                    Vector3 wheelRotation = WheelObj.GetRotation(0);

                    Vector3 targetPos = RAGE.Game.Object.GetObjectOffsetFromCoords(basePos.X, basePos.Y, basePos.Z, wheelRotation.Z, -0.9f, -0.8f, 1f);
                    ...
                    int win = ((byte)targetZoneType - 1) * 18;
