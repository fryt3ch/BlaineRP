...
namespace BlaineRP.Client.Game.EntitiesData.Vehicles
{
    public class VehicleData
    {
        ...
        public AttachmentEntity IsAttachedToVehicle
        {
            get
            {
                ...
                {
                    AttachmentEntity t = streamed[i].GetData<List<AttachmentEntity>>(Service.AttachedEntitiesKey)?.Where(x => x.RemoteID == Vehicle.RemoteId).FirstOrDefault();
        ...
        public Vehicle IsAttachedToLocalTrailer =>
            Vehicle.GetData<List<AttachmentObject>>(Service.AttachedObjectsKey)?.Where(x => x.Type == AttachmentType.TrailerObjOnBoat).FirstOrDefault()?.Object as Vehicle;
        ...
        public void Reset()
        {
            ...
            Scripts.Sync.Vehicles.ControlledVehicles.Remove(Vehicle);
