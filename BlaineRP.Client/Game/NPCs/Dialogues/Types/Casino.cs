...
namespace BlaineRP.Client.Game.NPCs.Dialogues
{
    ...
    public class Casino
    {
        public Casino()
        {
            new Dialogue("casino_cashier_def",
                null,
                async (args) =>
                {
                    ...
                    string[] data = args != null && args[0] is string t ? t.Split('_') : ((string)await npc.CallRemoteProc("Casino::GCBD"))?.Split('_');
                    ...
                    btns.Add(new Button($"[Купить фишки - ${casino.BuyChipPrice}]",
                            async () =>
                            {
                                ulong cashBalance = pData.Cash;

                                ulong maxChips = cashBalance / casino.BuyChipPrice;
                                ...
                                await ActionBox.ShowRange("CasinoChipsBuyRange",
                                    "Покупка фишек",
                                    1,
                                    maxChips,
                                    1,
                                    ...
                                    (rType, amountD) =>
                                    {
                                        ...
                                        npc.ShowDialogue("casino_cashier_cbuy_0",
                                            false,
                                            null,
                                            Locale.Get("GEN_CHIPS_1", amountD),
                                            Locale.Get("GEN_CHIPS_1", (ulong)System.Math.Floor(amountD * casino.BuyChipPrice))
                                        );
                                    },
                                    () =>
                                    {
                    ...
                    btns.Add(new Button($"[Продать фишки - ${casino.SellChipPrice}]",
                            async () =>
                            {
                                if (balance <= 0)
                                {
                                ...
                                await ActionBox.ShowRange("CasinoChipsBuyRange",
                                    ...
                                    (rType, amountD) =>
                                    {
                                        ...
                                        npc.ShowDialogue("casino_cashier_csell_0",
                                            false,
                                            null,
                                            Locale.Get("GEN_CHIPS_1", amountD),
                                            Locale.Get("GEN_CHIPS_1", (ulong)System.Math.Floor(amountD * casino.SellChipPrice))
                                        );
                                    },
                                    () =>
                                    {
                    ...
                    Dialogue dialogue = Get("casino_cashier_def_0");
            ...
            new Dialogue("casino_cashier_cbuy_0",
                "Вы действительно хотите приобрести {0} фишек?\nИх стоимость составит ${1}",
                null,
                new Button("[Купить]",
                    async () =>
                    {
                        ...
                        decimal chipsToBuy = npc.GetTempDialogueData<decimal>("buy_chips_amount");
                        ...
                        npc.ShowDialogue("casino_cashier_def",
                            true,
                            new object[]
                            {
                                res,
            ...
            new Dialogue("casino_cashier_csell_0",
                "Вы действительно хотите продать {0} фишек?\nЗа них Вы получите ${1}",
                null,
                new Button("[Продать]",
                    async () =>
                    {
                        ...
                        decimal chipsToSell = npc.GetTempDialogueData<decimal>("sell_chips_amount");
