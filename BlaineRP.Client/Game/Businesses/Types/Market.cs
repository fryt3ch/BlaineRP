...
namespace BlaineRP.Client.Game.Businesses
{
    ...
    {
        public Market(int id, Vector3 positionInfo, uint price, uint rent, float tax, Utils.Vector4 positionInteract) : base(id, positionInfo, BusinessTypes.Market, price, rent, tax)
        {
