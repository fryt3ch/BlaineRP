...
namespace BlaineRP.Client.Game.Businesses
{
    ...
    {
        public ClothesShop3(int id, Vector3 positionInfo, uint price, uint rent, float tax, Utils.Vector4 positionInteract) : base(id, positionInfo, BusinessTypes.ClothesShop3, price, rent, tax)
        {
