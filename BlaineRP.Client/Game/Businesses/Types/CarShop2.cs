...
namespace BlaineRP.Client.Game.Businesses
{
    ...
    {
        public CarShop2(int id, Vector3 positionInfo, uint price, uint rent, float tax, Utils.Vector4 positionInteract) : base(id, positionInfo, BusinessTypes.CarShop2, price, rent, tax)
        {
