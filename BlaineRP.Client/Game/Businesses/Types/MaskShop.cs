...
namespace BlaineRP.Client.Game.Businesses
{
    public class MaskShop : Business
    {
        ...
        public MaskShop(int id, Vector3 positionInfo, uint price, uint rent, float tax, Utils.Vector4 positionInteract) : base(id, positionInfo, BusinessTypes.MaskShop, price, rent, tax)
        {
            ...
            Seller = new NPC($"vendor_{id}", npcParams.Name, NPC.Types.Talkable, npcParams.Model, positionInteract.Position, positionInteract.RotationZ, Settings.App.Static.MainDimension)
            {
