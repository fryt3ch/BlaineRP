...
namespace BlaineRP.Client.Game.Businesses
{
    public class BagShop : Business
    {
        ...
        public BagShop(int id, Vector3 positionInfo, uint price, uint rent, float tax, Utils.Vector4 positionInteract) : base(id, positionInfo, BusinessTypes.BagShop, price, rent, tax)
        {
