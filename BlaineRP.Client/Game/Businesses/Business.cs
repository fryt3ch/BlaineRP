...
namespace BlaineRP.Client.Game.Businesses
{
    public abstract partial class Business
    {
        ...
        public ExtraBlip OwnerBlip
        {
            ...
            set
            {
                if (value == null) Player.LocalPlayer.ResetData($"Business::{Id}::OBlip");
        ...
        public Business(int Id, Vector3 PositionInfo, BusinessTypes Type, uint Price, uint Rent, float Tax)
        {
            ...
            {
                InfoColshape =
                    new Cylinder(new Vector3(PositionInfo.X, PositionInfo.Y, PositionInfo.Z - 1f),
                        1f,
                        1.5f,
                        false,
                        new Utils.Colour(255, 0, 0, 255),
                        Settings.App.Static.MainDimension,
                        null) { ActionType = ActionTypes.BusinessInfo, InteractionType = InteractionTypes.BusinessInfo, Data = this, };
