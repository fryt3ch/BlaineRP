...
namespace BlaineRP.Client.Game.Jobs
{
    public abstract partial class Job
    {
        ...
        public class Events
        {
            public Events()
            {
                RAGE.Events.Add("Player::SCJ", (args) =>
                {
                ...
                RAGE.Events.Add("Job::TR::OC", (args) =>
                {
                    var pData = PlayerData.GetData(Player.LocalPlayer);
                ...
                RAGE.Events.Add("Job::CL::OC", (args) =>
                {
                    var pData = PlayerData.GetData(Player.LocalPlayer);
                ...
                RAGE.Events.Add("Job::CAB::OC", (args) =>
                {
                    var pData = PlayerData.GetData(Player.LocalPlayer);
