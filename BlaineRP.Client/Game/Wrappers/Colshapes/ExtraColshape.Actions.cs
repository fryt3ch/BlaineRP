                ...
                {
                    {
                        true, (cs) =>
                        {
                            if (cs.Data is Locations.MarketStall marketStall)
                            {
                ...
                {
                    {
                        true, (cs) =>
                        {
                            if (cs.Data is Locations.Business biz)
                ...
                {
                    {
                        true, (cs) =>
                        {
                            if (!(cs.Data is Locations.HouseBase houseBase))
                                return;
                ...
                {
                    {
                        true, (cs) =>
                        {
                            if (cs.Data is Locations.TuningShop ts)
                        ...
                        true, (cs) =>
                        {
                            if (cs.Data is Locations.WeaponShop ws)
                            {
                                Core.OverrideInteractionText = string.Format(Locale.Interaction.Names.GetValueOrDefault(InteractionTypes.ShootingRangeEnter, "null"),
                                    Locations.WeaponShop.ShootingRangePrice);
