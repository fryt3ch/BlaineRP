...
namespace BlaineRP.Client.Game.Helpers.Colshapes.Types
{
    public class Circle : ExtraColshape
    {
        ...
        public Circle(Vector3 Position, float Radius, bool IsVisible, Utils.Colour Colour, uint Dimension, Colshape Colshape = null) : base(ColshapeTypes.Circle, IsVisible, Colour, Dimension, Colshape)
        {
            this.Radius = Radius;
