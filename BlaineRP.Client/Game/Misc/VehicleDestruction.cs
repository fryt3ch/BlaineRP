...
namespace BlaineRP.Client.Game.Misc
{
    public partial class VehicleDestruction
    {
        public VehicleDestruction(int id, Vector3 Position)
        {
            ...
            var cs = new Cylinder(new Vector3(Position.X, Position.Y, Position.Z), 7.5f, 5f, false, Utils.Misc.RedColor, Settings.App.Static.MainDimension, null)
            {
            ...
            var marker = new Marker(29,
                new Vector3(Position.X, Position.Y, Position.Z + 1.5f),
                2.5f,
                Vector3.Zero,
                Vector3.Zero,
