...
{
    [Script]
    public class BlipsInitialization
    {
        public BlipsInitialization()
        {
            ...
            new ExtraBlip(728,
                new Vector3(-1148.351f, -1698.468f, 20f),
                Locale.Get("BLIP_MARKETSTALLS"),
                1f,
                3,
                255,
                0f,
            ...
            new ExtraBlip(60,
                new Vector3(-444f, 6016f, 0f),
                Fraction.Get(FractionTypes.COP_BLAINE)?.Name ?? FractionTypes.COP_BLAINE.ToString(),
                1f,
                63,
                255,
                0f,
            ...
            new ExtraBlip(498,
                ...
                Fraction.Get(FractionTypes.FIB_LS)?.Name ?? FractionTypes.FIB_LS.ToString(),
                1f,
                29,
                255,
                0f,
            ...
            new ExtraBlip(744,
                new Vector3(-598.7835f, -929.9023f, 0f),
                Fraction.Get(FractionTypes.MEDIA_LS)?.Name ?? FractionTypes.MEDIA_LS.ToString(),
                1f,
                1,
                255,
                0f,
            ...
            new ExtraBlip(61,
                ...
                Fraction.Get(FractionTypes.EMS_BLAINE)?.Name ?? FractionTypes.EMS_BLAINE.ToString(),
                1f,
                1,
                255,
                0f,
            ...
            new ExtraBlip(419,
                new Vector3(-548.8925f, -197.5878f, 0f),
                Fraction.Get(FractionTypes.GOV_LS)?.Name ?? FractionTypes.GOV_LS.ToString(),
                1f,
                0,
                255,
                0f,
            ...
            new ExtraBlip(362,
                new Vector3(80f, -1963f, 0f),
                Fraction.Get(FractionTypes.GANG_BALS)?.Name ?? FractionTypes.GANG_BALS.ToString(),
                1f,
                27,
                255,
                0f,
            ...
            new ExtraBlip(685,
                ...
                Fraction.Get(FractionTypes.MAFIA_ITALY)?.Name ?? FractionTypes.MAFIA_ITALY.ToString(),
                1f,
                5,
                255,
                0f,
