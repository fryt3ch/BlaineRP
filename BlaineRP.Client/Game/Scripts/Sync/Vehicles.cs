        ...
        public Vehicles()
        {
            ...
            Events.OnPlayerEnterVehicle += async (Vehicle vehicle, int seatId) =>
            {
                ...
                if (!vehicle.IsLocal)
                {
                    ...
                    Game.Management.Radio.Core.SetCurrentRadioStationType(data.Radio);
                }
                else
                {
                        ...
                        /*                    veh.SetDoorsLocked(2);
                            ...
                            AddDataHandler("Radio",
                                (vData, value, oldValue) =>
                                {
                                    ...
                                    Game.Management.Radio.Core.SetVehicleRadioStation(veh, statinTypeNum);
                                });
                            ...
                            AddDataHandler("Mods::TSColour",
                                (vData, value, oldValue) =>
                                {
                                    ...
                                    var colour = ((JObject)value)?.ToObject<Colour>();
                            ...
                            AddDataHandler("DirtLevel", (vData, value, oldValue) => { vData.Vehicle.SetDirtLevel(Utils.Convert.ToSingle(value)); });
                                ...
                                async (args) =>
                                {
                                    ...
                                    await ActionBox.ShowSelect("GarageVehiclePlaceSelect",
                                        ...
                                        (rType, idD) =>
                                        {
                                            ...
                                            {
                                                var vehicle = Interaction.CurrentEntity as Vehicle;
                            ...
                            Events.Add("Vehicles::WTS",
                                (args) =>
                                {
                                    var veh = Entities.Vehicles.GetAtRemote((ushort)(int)args[0]);
                            ...
                            public static void ToggleCruiseControl(bool ignoreIf = false)
                            {
                                ...
                                if (!ignoreIf)
                                {
                                    if (vehicle?.Exists != true || vehicle.GetPedInSeat(-1, 0) != Player.LocalPlayer.Handle || !vehicle.GetIsEngineRunning() ||
                            ...
                            public static async void Lock(bool? forceвState = null, Vehicle vehicle = null)
                            {
                                ...
                                if (vehicle == null)
                                {
                                    ...
                                    if (vehicle?.Exists != true || vehicle.GetPedInSeat(-1, 0) != Player.LocalPlayer.Handle)
                                        vehicle = Interaction.CurrentEntity as Vehicle ??
                            ...
                            private static void EnterVehicleRender()
                            {
                                ...
                                if (tStatus == 7 || veh?.Exists != true || veh.IsDead(0) ||
                                    ...
                                    timePassed > 7500 || timePassed > 1_000 && Utils.Game.Misc.AnyOnFootMovingControlJustPressed() ||
                            ...
                            public static void Park(Vehicle vehicle, int slot = -1)
                            {
                                ...
                                {
                                    var gRoot = Player.LocalPlayer.GetData<GarageRoot>("CurrentGarageRoot");
                            ...
                            public static List<Player> GetPlayersInVehicle(Vehicle veh)
                            {
                                ...
                                for (var i = -1; i < veh.GetMaxNumberOfPassengers(); i++)
                                {
                            ...
                            public static void StartDriverSync()
                            {
                                ...
                                var lastPos = veh.GetCoords(false);
                            ...
                            private static void ControlledTick()
                            {
                                for (var i = 0; i < ControlledVehicles.Count; i++)
                                {
                                    ...
                                    if (fSpeed != 0f)
                                    {
                                        var lms = Player.LocalPlayer.Vehicle == vData.Vehicle
                                            ? Player.LocalPlayer.HasData("ColshapeVehicleSpeedLimited")
                                                ? Player.LocalPlayer.GetData<float>("ColshapeVehicleSpeedLimited")
                                                : float.MinValue
                                            : float.MinValue;
                            ...
                            public static async void SetupPlate(Vehicle veh)
                            {
                                ...
                                for (var i = 0; i < Inventory.ItemsParams.Length; i++)
                                {
                                    ...
                                    if (Game.Items.Core.GetType(Inventory.ItemsParams[i].Id, false) == typeof(Numberplate))
                                    {
                                        var name = ((string)((object[])Inventory.ItemsData[i][0])[1]).Split(' ');
                            ...
                            private static void AutoPilotTick()
                            {
                                ...
                                if (veh?.Exists != true || veh.GetPedInSeat(-1, 0) != Player.LocalPlayer.Handle || !veh.GetIsEngineRunning() ||
                                ...
                                if (RAGE.Game.Pad.IsControlJustPressed(32, 133) || RAGE.Game.Pad.IsControlJustPressed(32, 134) || RAGE.Game.Pad.IsControlJustPressed(32, 130) ||
                                    RAGE.Game.Pad.IsControlJustPressed(32, 129) || RAGE.Game.Pad.IsControlJustPressed(32, 76))
                                {
                                    Notification.Show(Notification.Types.Information,
                                        Locale.Notifications.Vehicles.Additional.HeaderAutoPilot,
                                        Locale.Notifications.Vehicles.Additional.Invtervention);
                            ...
                            public static void SendCoordsToDriver()
                            {
                                ...
                                var wpPos = Main.WaypointPosition;
                            ...
                            public static async void BoatFromTrailerToWater(Vehicle veh)
                            {
                                ...
                                if (vData.IsAttachedToLocalTrailer is Vehicle trVeh)
                                {
                                    await ActionBox.ShowSelect("BoatFromTrailerSelect",
                                        ...
                                        new (decimal Id, string Text)[] { (0, "На воду"), (1, "На землю"), },
                                        null,
                                        null,
                                        ActionBox.DefaultBindAction,
                                        (rType, id) =>
