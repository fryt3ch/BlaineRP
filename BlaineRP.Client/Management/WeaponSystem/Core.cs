...
namespace BlaineRP.Client.Management.WeaponSystem
{
    [Script(int.MaxValue)]
    public class Core
    {
        ...
        public class WeaponInfo
        {
            ...
            public uint? GetComponentHash(ComponentTypes cType)
            {
            ...
            public WeaponInfo(string gameName, float baseDamage, float maxDistance, float distanceRatio, float headRatio, float chestRatio, float limbRatio, bool hasAmmo = true)
            {
                ...
                BodyRatios = new Dictionary<PartTypes, float>()
                {
        ...
        public static List<WeaponInfo> WeaponList = new List<WeaponInfo>()
        {
            ...
            {
                ComponentsHashes = new Dictionary<WeaponInfo.ComponentTypes, uint>()
                {
                    { WeaponInfo.ComponentTypes.Suppressor, RAGE.Util.Joaat.Hash("COMPONENT_AT_PI_SUPP_02") },
                    { WeaponInfo.ComponentTypes.Flashlight, RAGE.Util.Joaat.Hash("COMPONENT_AT_PI_FLSH") },
                }
            },
            new WeaponInfo("weapon_pistol_mk2", 10f, 90f, 0.1f, 1.5f, 1f, 0.5f)
            {
                ...
                {
                    { WeaponInfo.ComponentTypes.Suppressor, RAGE.Util.Joaat.Hash("COMPONENT_AT_PI_SUPP_02") },
                    { WeaponInfo.ComponentTypes.Flashlight, RAGE.Util.Joaat.Hash("COMPONENT_AT_PI_FLSH_02") },
                }
            },
            new WeaponInfo("weapon_combatpistol", 10f, 75f, 0.12f, 1.5f, 1f, 0.5f)
            {
                ComponentsHashes = new Dictionary<WeaponInfo.ComponentTypes, uint>()
                {
                    { WeaponInfo.ComponentTypes.Suppressor, RAGE.Util.Joaat.Hash("COMPONENT_AT_PI_SUPP") },
                    { WeaponInfo.ComponentTypes.Flashlight, RAGE.Util.Joaat.Hash("COMPONENT_AT_PI_FLSH") },
                }
            },
            ...
            new WeaponInfo("weapon_ceramicpistol", 8f, 80f, 0.1f, 1.5f, 1f, 0.5f)
            {
                ComponentsHashes = new Dictionary<WeaponInfo.ComponentTypes, uint>()
                {
                    { WeaponInfo.ComponentTypes.Suppressor, RAGE.Util.Joaat.Hash("COMPONENT_CERAMICPISTOL_SUPP") },
                }
            },
            ...
            new WeaponInfo("weapon_smg", 6f, 60f, 0.1f, 1.5f, 1f, 0.5f)
            {
                ...
                {
                    { WeaponInfo.ComponentTypes.Suppressor, RAGE.Util.Joaat.Hash("COMPONENT_AT_PI_SUPP") },
                    { WeaponInfo.ComponentTypes.Flashlight, RAGE.Util.Joaat.Hash("COMPONENT_AT_AR_FLSH") },
                    { WeaponInfo.ComponentTypes.Scope, RAGE.Util.Joaat.Hash("COMPONENT_AT_SCOPE_MACRO_02") },
                }
            },
            new WeaponInfo("weapon_smg_mk2", 7f, 70f, 0.08f, 1.5f, 1f, 0.5f)
            {
                ComponentsHashes = new Dictionary<WeaponInfo.ComponentTypes, uint>()
                {
                    { WeaponInfo.ComponentTypes.Suppressor, RAGE.Util.Joaat.Hash("COMPONENT_AT_PI_SUPP") },
                    { WeaponInfo.ComponentTypes.Flashlight, RAGE.Util.Joaat.Hash("COMPONENT_AT_AR_FLSH") },
                    { WeaponInfo.ComponentTypes.Scope, RAGE.Util.Joaat.Hash("COMPONENT_AT_SCOPE_MACRO_02_SMG_MK2") },
                }
            },
            new WeaponInfo("weapon_assaultsmg", 8f, 75f, 0.08f, 1.5f, 1f, 0.5f)
            {
                ComponentsHashes = new Dictionary<WeaponInfo.ComponentTypes, uint>()
                {
                    { WeaponInfo.ComponentTypes.Suppressor, RAGE.Util.Joaat.Hash("COMPONENT_AT_AR_SUPP_02") },
                    { WeaponInfo.ComponentTypes.Flashlight, RAGE.Util.Joaat.Hash("COMPONENT_AT_AR_FLSH") },
                    { WeaponInfo.ComponentTypes.Scope, RAGE.Util.Joaat.Hash("COMPONENT_AT_SCOPE_MACRO") },
                }
            },
            new WeaponInfo("weapon_combatpdw", 8f, 80f, 0.08f, 1.5f, 1f, 0.5f)
            {
                ...
                {
                    { WeaponInfo.ComponentTypes.Flashlight, RAGE.Util.Joaat.Hash("COMPONENT_AT_AR_FLSH") },
                    { WeaponInfo.ComponentTypes.Scope, RAGE.Util.Joaat.Hash("COMPONENT_AT_SCOPE_SMALL") },
                    { WeaponInfo.ComponentTypes.Grip, RAGE.Util.Joaat.Hash("COMPONENT_AT_AR_AFGRIP") },
                }
            },
            ...
            new WeaponInfo("weapon_carbinerifle", 9f, 100f, 0.09f, 1.5f, 1f, 0.5f)
            {
                ComponentsHashes = new Dictionary<WeaponInfo.ComponentTypes, uint>()
                {
                    { WeaponInfo.ComponentTypes.Suppressor, RAGE.Util.Joaat.Hash("COMPONENT_AT_AR_SUPP") },
                    { WeaponInfo.ComponentTypes.Flashlight, RAGE.Util.Joaat.Hash("COMPONENT_AT_AR_FLSH") },
                    { WeaponInfo.ComponentTypes.Scope, RAGE.Util.Joaat.Hash("COMPONENT_AT_SCOPE_MEDIUM") },
                    { WeaponInfo.ComponentTypes.Grip, RAGE.Util.Joaat.Hash("COMPONENT_AT_AR_AFGRIP") },
                }
            },
            ...
            new WeaponInfo("weapon_assaultriflemk2", 9f, 110f, 0.08f, 1.5f, 1f, 0.5f)
            {
                ComponentsHashes = new Dictionary<WeaponInfo.ComponentTypes, uint>()
                {
                    { WeaponInfo.ComponentTypes.Suppressor, RAGE.Util.Joaat.Hash("COMPONENT_AT_AR_SUPP_02") },
                    { WeaponInfo.ComponentTypes.Flashlight, RAGE.Util.Joaat.Hash("COMPONENT_AT_AR_FLSH") },
                    { WeaponInfo.ComponentTypes.Scope, RAGE.Util.Joaat.Hash("COMPONENT_AT_SCOPE_MACRO_MK2") },
                    { WeaponInfo.ComponentTypes.Grip, RAGE.Util.Joaat.Hash("COMPONENT_AT_AR_AFGRIP_02") },
                }
            },
            ...
            new WeaponInfo("weapon_combatmg", 9f, 70f, 0.12f, 1.5f, 1f, 0.5f)
            {
                ComponentsHashes = new Dictionary<WeaponInfo.ComponentTypes, uint>()
                {
                    { WeaponInfo.ComponentTypes.Scope, RAGE.Util.Joaat.Hash("COMPONENT_AT_SCOPE_SMALL_02") },
                }
            },
            ...
            new WeaponInfo("weapon_pumpshotgun", 40f, 10f, 4f, 2f, 1f, 0.5f)
            {
                ...
                {
                    { WeaponInfo.ComponentTypes.Flashlight, RAGE.Util.Joaat.Hash("COMPONENT_AT_AR_FLSH") },
                    { WeaponInfo.ComponentTypes.Suppressor, RAGE.Util.Joaat.Hash("COMPONENT_AT_SR_SUPP") },
                }
            },
            new WeaponInfo("weapon_pumpshotgun_mk2", 50f, 15f, 3f, 2f, 1f, 0.5f)
            {
                ...
                {
                    { WeaponInfo.ComponentTypes.Flashlight, RAGE.Util.Joaat.Hash("COMPONENT_AT_AR_FLSH") },
                    { WeaponInfo.ComponentTypes.Suppressor, RAGE.Util.Joaat.Hash("COMPONENT_AT_SR_SUPP_03") },
                    { WeaponInfo.ComponentTypes.Scope, RAGE.Util.Joaat.Hash("COMPONENT_AT_SCOPE_MACRO_MK2") },
                }
            },
            ...
            new WeaponInfo("weapon_heavysniper", 150f, 500f, 0.25f, 2f, 1f, 0.5f)
            {
                ComponentsHashes = new Dictionary<WeaponInfo.ComponentTypes, uint>()
                {
                    { WeaponInfo.ComponentTypes.Scope, RAGE.Util.Joaat.Hash("COMPONENT_AT_SCOPE_LARGE") },
                }
            },
        };
        ...
        public Core()
        {
            ...
            LastAttackerInfo = (Player.LocalPlayer, 0, -1, World.ServerTime);
            ...
            Events.OnPlayerDeath += (Player player, uint reason, Player killer, Events.CancelEventArgs cancel) =>
            {
                ...
                if (pData != null)
                {
                    ...
                    if ((killer?.Exists != true || killer.Handle == Player.LocalPlayer.Handle) && World.ServerTime.Subtract(LastAttackerInfo.Time).TotalMilliseconds <= 1000)
            ...
            {
                LastWeaponShot = World.ServerTime;
        ...
        public static void UpdateWeaponComponents(Player player, string strData)
        {
            ...
            if (curGunData?.ComponentsHashes != null)
            {
                ...
                wcData.Skip(2).Where(x => x.Length > 0).Select(x => curGunData.GetComponentHash((WeaponInfo.ComponentTypes)int.Parse(x))).ToList().ForEach((x) =>
                {
                    if (x is uint hash)
                    {
        ...
        public static void UpdateWeaponObjectComponents(int objHandle, uint wHash, string strData)
        {
            ...
            if (curGunData?.ComponentsHashes != null)
            {
                wcData.Skip(1).Where(x => x.Length > 0).Select(x => curGunData.GetComponentHash((WeaponInfo.ComponentTypes)int.Parse(x))).ToList().ForEach((x) =>
                {
                    if (x is uint hash)
                    {
        ...
        public static void UpdateWeapon()
        {
            ...
            if (curAmmo == 0 && RAGE.Game.Player.IsPlayerFreeAiming() && (RAGE.Game.Pad.IsControlPressed(32, 24) || RAGE.Game.Pad.IsDisabledControlPressed(32, 24)) && Settings.User.Interface.AutoReload)
            {
                ...
                if (!LastSentReload.IsSpam(2000, false, false))
                {
                    ...
                    LastSentReload = World.ServerTime;
                }
            }
        }
        ...
        public static void DamageWatcher()
        {
            ...
            if (armourLoss > 0)
                LastArmourLoss = World.ServerTime;
        }
        ...
        private static void IncomingDamage(Player sourcePlayer, Entity sourceEntity, Entity targetEntity, ulong weaponHashLong, ulong notWorkingShit, int boneIdx, Events.CancelEventArgs cancel)
        {
            ...
            if (sourceEntity is Player sP)
            {
                ...
                if (targetEntity is Player targetPlayer)
                {
                    ...
                    if (customDamage >= 0)
                    {
                        LastAttackerInfo = (sourcePlayer, customDamage + 1, boneIdx, World.ServerTime);
        ...
        private static void OutgoingDamage(Entity sourceEntity, Entity targetEntity, Player targetPlayer, ulong weaponHashLong, ulong boneIdx, int damage, Events.CancelEventArgs cancel)
        {
            ...
            if (targetEntity is Vehicle veh)
            {
                ...
                else
                {
                    ...
                    LastSentVehicleDamage = World.ServerTime;
                }
            }
            else
            {
                ...
                else
                {
                    ...
                    LastSentPedDamage = World.ServerTime;
                }
            }
        }
