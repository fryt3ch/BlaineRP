    ...
    public class FishBuyer
    {
        public FishBuyer()
        {
            new Dialogue("fishbuyer_0_g", "Приветствую! Я занимаюсь скупкой рыбы, у тебя есть что-нибудь для меня? Готов предложить неплохие деньги", null,
                new Dialogue.Button("Сейчас посмотрю", () => NPC.CurrentNPC?.ShowDialogue("fishbuyer_a_fs0", false, null)),

                new Dialogue.Button("Так, а что по ценам?", () =>
                {
            ...
            new Dialogue("fishbuyer_a_fs0", null,
                (args) =>
                {
                    ...
                    foreach (var x in dict)
                    {
                        ...
                        dg.Buttons.Add(new Dialogue.Button($"{name} - {amount} шт.", () =>
                        {
                    ...
                    dg.Buttons.Add(new Dialogue.Button($"Вся рыба - {sum} шт.", () =>
                    {
                    ...
                    dg.Buttons.Add(Dialogue.Button.DefaultBackButton);
                    dg.Buttons.Add(Dialogue.Button.DefaultExitButton);
            ...
            new Dialogue("fishbuyer_a_fs2", "Так, {0}, хорошо, сколько штук? За 1 шт. я дам {1}, следовательно, за всю, что у тебя есть, а это {2} шт. - {3}", null,
                new Dialogue.Button("[Выбрать кол-во]", async () =>
                {
                    var npc = NPC.CurrentNPC;
                ...
                new Dialogue.Button("[Продать всю]", () =>
                {
                    var npc = NPC.CurrentNPC;
