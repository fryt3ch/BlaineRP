...
namespace BlaineRP.Client.Settings.User
{
    public static class Aim
    {
        ...
        public static Types Type
        {
            ...
            {
                if (value != _Type)
                    RageStorage.SetData("Settings::Interface::Aim::Type", value);
                _Type = value;
            }
        }

        public static Utils.Colour Color
        {
            get => _Color;
            set
            {
                if (value != _Color)
                    RageStorage.SetData("Settings::Interface::Aim::Color", value);
                _Color = value;
            }
        }
        ...
        public static float Alpha
        {
            ...
            {
                if (value != _Alpha)
                    RageStorage.SetData("Settings::Interface::Aim::Alpha", value);
                _Alpha = value;
            }
        }
        ...
        public static float Scale
        {
            ...
            {
                if (value != _Scale)
                    RageStorage.SetData("Settings::Interface::Aim::Scale", value);
                _Scale = value;
            }
        }
