...
namespace BlaineRP.Client.Sync
{
    ...
    public class AttachSystem
    {
        ...
        public static bool IsTypeStaticObject(Types type)
        {
            return type >= Types.PedRingLeft3 && type < Types.VehKey;
        }

        public static bool IsTypeObjectInHand(Types type)
        {
            return type >= Types.VehKey && type < Types.VehicleTrailer;
        }
        ...
        public static Dictionary<Types, AttachmentData> Attachments = new Dictionary<Types, AttachmentData>()
        {
            ...
            {
                Types.ItemFishG, new AttachmentData(int.MinValue,
                    null,
            ...
            {
                Types.ItemCigHand, new AttachmentData(64097,
            ...
            {
                Types.ItemCig1Hand, new AttachmentData(64097,
            ...
            {
                Types.ItemCig2Hand, new AttachmentData(64097,
                    new Vector3(0.02f, 0.02f, -0.008f),
                    new Vector3(100f, 0f, -100f),
                    false,
                    false,
            ...
            {
                Types.ItemCig3Hand, new AttachmentData(64097,
                    new Vector3(0.02f, 0.02f, -0.008f),
                    new Vector3(100f, 0f, 100f),
                    false,
                    false,
            ...
            {
                Types.ItemCigMouth, new AttachmentData(47419,
            ...
            {
                Types.ItemCig1Mouth, new AttachmentData(47419,
            ...
            {
                Types.ItemCig2Mouth, new AttachmentData(47419,
            ...
            {
                Types.ItemCig3Mouth, new AttachmentData(47419,
                    new Vector3(0.01f, 0f, 0f),
                    new Vector3(50f, 0f, 80f),
                    false,
                    false,
            ...
            {
                Types.FarmPlantSmallShovel, new AttachmentData(28422,
            ...
            {
                Types.FarmWateringCan, new AttachmentData(28422,
        ...
        public static async System.Threading.Tasks.Task AttachObject(Entity target, AttachmentObjectNet attachmentNet)
        {
            ...
            if (attachmentNet.Type >= Types.WeaponRightTight && attachmentNet.Type <= Types.WeaponLeftBack)
            {
                ...
                if (attachmentNet.SyncData != null)
                    WeaponSystem.UpdateWeaponObjectComponents(gEntity.Handle, attachmentNet.Model, attachmentNet.SyncData);
            }
        ...
        private static Dictionary<Types, (Action On, Action Off, Action Loop)?> TargetActions = new Dictionary<Types, (Action On, Action Off, Action Loop)?>()
        {
            ...
            {
                Types.VehicleTrunk, (new Action(() => { WeaponSystem.DisabledFiring = true; }), new Action(() => { WeaponSystem.DisabledFiring = false; }), new Action(() =>
                {
                    ...
                    var bind = Core.Get(Input.Enums.BindTypes.CancelAnimation);
            ...
            {
                Types.Carry, (new Action(() => { WeaponSystem.DisabledFiring = true; }), new Action(() => { WeaponSystem.DisabledFiring = false; }), new Action(() =>
                {
                    var pData = PlayerData.GetData(Player.LocalPlayer);
        ...
        private static Dictionary<Types, (Action On, Action Off, Action Loop)?> RootActions = new Dictionary<Types, (Action On, Action Off, Action Loop)?>()
        {
            ...
            },
            {
                ...
                }), new Action(() =>
                {
                    ...
                    else
                    {
                        ...
                        // alt - to mouth
                        else if ((!CEF.Cursor.IsVisible && Core.IsJustDown(RAGE.Ui.VirtualKeys.LeftMenu) || Player.LocalPlayer.Vehicle != null) &&
            ...
            {
                Types.ItemCigMouth, (new Action(() => { Player.LocalPlayer.SetData("Temp::Smoke::LastSent", World.ServerTime); }),
                    new Action(() => { Player.LocalPlayer.ResetData("Temp::Smoke::LastSent"); }), new Action(() =>
                    {
                        ...
                        else
                        {
                            ...
                            {
                                // alt - to hand
                                if (!CEF.Cursor.IsVisible && Core.IsJustDown(RAGE.Ui.VirtualKeys.LeftMenu))
            ...
            {
                Types.FarmPlantSmallShovel, (null, null, new Action(() =>
                {
                    var bind = Core.Get(Input.Enums.BindTypes.CancelAnimation);
            ...
            {
                Types.FarmWateringCan, (null, null, new Action(() =>
                {
                    var bind = Core.Get(Input.Enums.BindTypes.CancelAnimation);
            ...
            {
                Types.FarmOrangeBoxCarry, (new Action(() =>
                {
            ...
            {
                Types.FarmMilkBucketCarry, (new Action(() =>
                {
                    var farmBusiness = (PlayerData.GetData(Player.LocalPlayer)?.CurrentJob as Data.Jobs.Farmer)?.FarmBusiness;
            ...
            {
                Types.EmsHealingBedFakeAttach, (null, () => { Additional.ExtraColshape.All.Where(x => x.Name == "ems_healing_bed").ToList().ForEach(x => x.Destroy()); },
                    new Action(
                        () =>
                        {
                            var bind = Core.Get(Input.Enums.BindTypes.CancelAnimation);
            ...
            },
            {
                Types.Cuffs, (() =>
                {
                    ...
                    Core.Get(Input.Enums.BindTypes.Crawl)?.Disable();
                ...
                }, () =>
                {
                    ...
                    Core.Get(Input.Enums.BindTypes.Crawl)?.Enable();
                ...
                }, () =>
                {
                    ...
                    if (lockpickItemAmount > 0)
                    {
                        ...
                        {
                            Graphics.DrawText(string.Format("Нажмите {0}, чтобы воспользоваться отмычкой (x{1})", Core.GetKeyString(key), lockpickItemAmount),
                                0.5f,
                                0.95f,
                                255,
                                255,
            ...
            },
            {
                Types.PoliceEscort, (() =>
                {
                    ...
                    Core.Get(Input.Enums.BindTypes.Crouch)?.Disable();
                    Core.Get(Input.Enums.BindTypes.Crawl)?.Disable();
                }, () =>
                {
                    WeaponSystem.DisabledFiring = false;

                    Core.Get(Input.Enums.BindTypes.Crouch)?.Enable();
                    Core.Get(Input.Enums.BindTypes.Crawl)?.Enable();
                }, async () =>
                {
            ...
            },
            {
                Types.PlayerResurrect, (() =>
                {
                    ...
                    var attach = PlayerData.GetData(Player.LocalPlayer).AttachedEntities.Where(x => x.Type == Types.PlayerResurrect).FirstOrDefault();
