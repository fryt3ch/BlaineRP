...
/*                    Utils.ConsoleOutput(slotMachineId);
...

            {
                InteractionTypes.ElevatorInteract, async () =>
                {
                    ...
                    (
                        "ElevatorSelect", "Выбор места перемещения", elevatorData.LinkedElevators.Select(x => ((decimal)x, Locations.Elevator.GetName(x))).ToArray(), null, null,
...

            {
                InteractionTypes.FractionPoliceArrestMenuInteract, async () =>
                {
                    ...
                    var fData = Fraction.Get((Data.Fractions.Types)int.Parse(fTypeS[0]));
...

            {
                InteractionTypes.BusinessInfo, () =>
                {
                    ...
                    CEF.Estate.ShowBusinessInfo(Player.LocalPlayer.GetData<Locations.Business>("CurrentBusiness"), true);
...

            {
                InteractionTypes.HouseEnter, () =>
                {
                    ...
                    CEF.Estate.ShowHouseBaseInfo(Player.LocalPlayer.GetData<Locations.HouseBase>("CurrentHouse"), true);
...

            {
                InteractionTypes.GarageRootEnter, () =>
                {
                    ...
                    CEF.GarageMenu.Show(Player.LocalPlayer.GetData<Locations.GarageRoot>("CurrentGarageRoot"));
                ...
                {
                    {
                        ...
                        (cs) =>
                        {
                            if (cs.Data is string str)
                            {
                                ...
                                var casino = Locations.Casino.GetById(int.Parse(d[0]));
                ...
                {
                    {
                        ...
                        (cs) =>
                        {
                            if (cs.Data is Locations.WeaponShop ws)
                            {
                                ExtraColshapes.OverrideInteractionText = string.Format(Locale.Interaction.Names.GetValueOrDefault(InteractionTypes.ShootingRangeEnter, "null"), Locations.WeaponShop.ShootingRangePrice);
                ...
                {
                    {
                        ...
                        (cs) =>
                        {
                            if (cs.Data is Locations.ApartmentsRoot aRoot)
                            {
                ...
                {
                    {
                        ...
                        (cs) =>
                        {
                            if (cs.Data is Locations.GarageRoot gRoot)
                            {
