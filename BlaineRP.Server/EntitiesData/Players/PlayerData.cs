            ...
            {
                {
                    ...
                    {
                        Weapons.Select(x => Item.ToClientJson(x, Inventory.GroupTypes.Weapons)).SerializeToJson(),
                        Item.ToClientJson(Armour, Inventory.GroupTypes.Armour),
                        Items.Select(x => Item.ToClientJson(x, Inventory.GroupTypes.Items)).SerializeToJson(),
                        Clothes.Select(x => Item.ToClientJson(x, Inventory.GroupTypes.Clothes)).SerializeToJson(),
                        Accessories.Select(x => Item.ToClientJson(x, Inventory.GroupTypes.Accessories)).SerializeToJson(),
                        Item.ToClientJson(Bag, Inventory.GroupTypes.BagItem),
                        Item.ToClientJson(Holster, Inventory.GroupTypes.HolsterItem),
                    }
                },
