...
namespace BlaineRP.Server.EntitiesData.Players
{
    public class PlayerInfo
    {
        ...
        public static UtilsT.UidHandlers.UInt32 UidHandler { get; private set; } = new UtilsT.UidHandlers.UInt32(Properties.Settings.Profile.Current.Game.CIDBaseOffset);
        ...
        public static PlayerInfo Get(uint id)
        {
            return All.GetValueOrDefault(id);
        }

        public static List<PlayerInfo> GetAllByAID(uint aid)
        {
            return All.Values.Where(x => x?.AID == aid).ToList();
        }
        ...
        public HashSet<LicenseType> Licenses { get; set; }
        ...
        public List<VehicleInfo> OwnedVehicles => VehicleInfo.GetAllByCID(CID);
        ...
        public List<SMS> AllSMS { get; set; }
