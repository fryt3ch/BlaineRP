...
namespace BlaineRP.Server.Game.EntitiesData.Players
{
    public partial class PlayerData
    {
        ...
        public Container CurrentContainer { get => Player.GetData<Container>("CCont"); set { if (value == null) Player.ResetData("CCont"); else Player.SetData("CCont", value); } }

        public Game.Craft.Workbenches.Workbench CurrentWorkbench { get => Player.GetData<Game.Craft.Workbenches.Workbench>("CWBench"); set { if (value == null) Player.ResetData("CWBench"); else Player.SetData("CWBench", value); } }
        ...
        public List<(Game.Items.Item Item, GroupTypes Group, int Slot)> TempItems { get => Player.GetData<List<(Game.Items.Item, GroupTypes, int)>>("TempItems"); set { if (value == null) Player.ResetData("TempItems"); else Player.SetData("TempItems", value); } }
        ...
        public List<Gift> Gifts { get => Info.Gifts; set => Info.Gifts = value; }
        ...
        public IEnumerable<Game.World.Service.ItemOnGround> OwnedItemsOnGround => Game.World.Service.GetItemsOnGroundByOwner(Info);
        ...
        public bool StopUseCurrentItem()
        {
            ...
            {
                item.StopUse(this, GroupTypes.Items, slot, true);
        ...
        public bool TryGetActiveWeapon(out Game.Items.Weapon weaponItem, out GroupTypes group, out int slot)
        {
        ...
        {
            Game.Items.Weapon weapon; GroupTypes group; int slot;
