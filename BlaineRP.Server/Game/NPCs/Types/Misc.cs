...
namespace BlaineRP.Server.Game.NPCs.Types
{
    internal class Misc
    {
        ...
        private static object VehicleRentSPay(PlayerData pData, string npcId, string[] data)
        {
            ...
            var vTypeData = Game.EntitiesData.Vehicles.Static.Service.GetData("faggio");
        ...
        private static object FishBuyerSell(PlayerData pData, string npcId, string[] data)
        {
            ...
            if (fishId == string.Empty)
            {
                ...
                foreach (var x in slotsToUpdate)
                    pData.Player.InventoryUpdate(GroupTypes.Items, x, Game.Items.Item.ToClientJson(pData.Items[x], GroupTypes.Items));
