...
namespace BlaineRP.Server.Game.Items.Craft
{
    ...
    {
        private static Dictionary<Inventory.GroupTypes, Dictionary<Inventory.GroupTypes, Func<PlayerData, Workbench, int, int, int, Inventory.ResultTypes>>> ReplaceActions = new Dictionary<Inventory.GroupTypes, Dictionary<Inventory.GroupTypes, Func<PlayerData, Workbench, int, int, int, Inventory.ResultTypes>>>()
        {
            {
                Inventory.GroupTypes.Items,

                new Dictionary<Inventory.GroupTypes, Func<PlayerData, Workbench, int, int, int, Inventory.ResultTypes>>()
                {
                    {
                        Inventory.GroupTypes.CraftItems,
                        ...
                        (pData, wb, slotTo, slotFrom, amount) =>
                        {
                            ...
                            if (toItem is WorkbenchTool)
                                return Inventory.ResultTypes.Error;
...
/*                            if (!wb.IsItemAllowed(toItem))
                    ...
                    {
                        Inventory.GroupTypes.CraftTools,
            ...
            {
                Inventory.GroupTypes.CraftResult,
