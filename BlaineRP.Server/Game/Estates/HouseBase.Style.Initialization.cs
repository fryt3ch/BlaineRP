            ...
            public static void LoadAll()
            {
                ...
                new Style(Type: 0,
                    ...
                    Lights: new LightInfo[][]
                    {
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(0f, 0f, 3.976f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(0f, -5.349999f, 3.976f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(5.400002f, -6.099998f, 3.976f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(5.641205f, 4.258736f, 3.976f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(3.800003f, -0.75f, 3.976f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_2_1", new Vector3(6.75f, -0.75f, 3.95f))
                        },
                    },
                    SupportedHouseTypes: new HashSet<HouseBase.Types>()
                    {
                        HouseBase.Types.House,
                    },
                    SupportedRoomTypes: new HashSet<RoomTypes>()
                    {
                        RoomTypes.Two,
                    },
                    Price: 10_000
                ...
                new Style(Type: 10,
                    ...
                    Heading: 177.6222f,
                    InteriorPosition: new Vector4(-850f, 3440f, -180f, 6.94992f),
                    Doors: new DoorInfo[]
                    {
                    ...
                    Lights: new LightInfo[][]
                    {
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(0.3443137f, 1.061796f, 1.483612f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(-2.582341f, 2.22257f, 1.483612f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(-3.406205f, -1.783329f, 1.483612f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(3.372307f, -1.298711f, 1.483612f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(-0.1508973f, -2.840963f, 1.483612f))
                        },
                    },
                    SupportedHouseTypes: new HashSet<HouseBase.Types>()
                    {
                ...
                new Style(Type: 20,
                    ...
                    Heading: 177.7124f,
                    InteriorPosition: new Vector4(-850f, 3440f + 35f, -180f, 7.52497f),
                    Doors: new DoorInfo[]
                    {
                    ...
                    Lights: new LightInfo[][]
                    {
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(-0.9984746f, 38.96366f, 1.483612f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(2.943951f, 36.38088f, 1.483612f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(1.71268f, 33.98152f, 1.483612f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(-2.398272f, 34.93951f, 1.483612f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(-1.027865f, 30.95322f, 1.483612f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(0.4503248f, 36.07869f, 1.483612f))
                        },
                    },
                    SupportedHouseTypes: new HashSet<HouseBase.Types>()
                    {
                ...
                new Style(Type: 30,
                    ...
                    Heading: 86.09361f,
                    InteriorPosition: new Vector4(-850f, 3440f + 70f, -180f, 7.0415f),
                    Doors: new DoorInfo[]
                    {
                    ...
                    Lights: new LightInfo[][]
                    {
                        ...
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(1.832659f, 72.88146f, 1.483612f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(2.793969f, 67.21001f, 1.483612f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(-2.349123f, 67.70047f, 1.483612f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(-1.305994f, 72.57049f, 1.483612f))
                        },
                    },
                    SupportedHouseTypes: new HashSet<HouseBase.Types>()
                    {
                ...
                new Style(Type: 40,
                    ...
                    Heading: 273.0863f,
                    InteriorPosition: new Vector4(-850f, 3440f + 105f, -180f, 9.53456f),
                    Doors: new DoorInfo[]
                    {
                    ...
                    Lights: new LightInfo[][]
                    {
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(-1.065282f, 105.1964f, 0.1691258f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(-1.950482f, 101.1643f, 0.1691258f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(1.822946f, 102.3438f, 0.1691258f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(-1.478506f, 109.2319f, 0.1691258f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(3.212504f, 109.1722f, 0.1691258f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(-2.036492f, 108.8396f, 3.769073f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(2.648248f, 108.9481f, 3.769073f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(0.9117524f, 102.3212f, 3.769073f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(-2.188939f, 100.9081f, 3.769073f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(1.877401f, 99.74334f, 3.769073f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(-1.16269f, 105.1631f, 3.769073f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_4_0", new Vector3(4.060811f, 99.72443f, -0.501879f))
                        },
                    },
                    SupportedHouseTypes: new HashSet<HouseBase.Types>()
                    {
                ...
                new Style(Type: 50,
                    ...
                    Heading: 85.65966f,
                    InteriorPosition: new Vector4(-850f, 3440f + 140f, -180f, 7.81977f),
                    Doors: new DoorInfo[]
                    {
                    ...
                    Lights: new LightInfo[][]
                    {
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(2.972252f, 138.9892f, 1.481776f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(3.027311f, 134.9848f, 1.481776f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(-1.603372f, 136.0336f, 1.481776f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(0.8066364f, 144.0647f, 1.481776f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(-3.526964f, 142.1393f, 1.481777f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(-0.5216536f, 140.2679f, 1.481777f))
                        },
                    },
                    SupportedHouseTypes: new HashSet<HouseBase.Types>()
                    {
                ...
                new Style(Type: 60,
                    ...
                    Heading: 127.9297f,
                    InteriorPosition: new Vector4(-850f, 3440f + 175f, -180f, 8.46709f),
                    Doors: new DoorInfo[]
                    {
                    ...
                    Lights: new LightInfo[][]
                    {
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(1.640707f, 174.8707f, 1.456776f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(4.936249f, 173.578f, 1.456777f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(-1.695213f, 178.8944f, 1.456776f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(-1.814014f, 171.1266f, 1.456776f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(-2.059127f, 174.9795f, 1.456776f))
                        },
                    },
                    SupportedHouseTypes: new HashSet<HouseBase.Types>()
                    {
                ...
                new Style(Type: 70,
                    ...
                    Heading: 175.8804f,
                    InteriorPosition: new Vector4(-850f, 3440f + 210f, -180f, 7.58965f),
                    Doors: new DoorInfo[]
                    {
                    ...
                    Lights: new LightInfo[][]
                    {
                        ...
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(3.934543f, 210.5374f, 1.481776f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(2.929501f, 206.8474f, 1.481777f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(-1.382281f, 208.2117f, 1.481776f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(-2.141615f, 213.1263f, 1.481777f))
                        },
                    },
                    Price: 10_000,
                    SupportedHouseTypes: new HashSet<HouseBase.Types>()
                ...
                new Style(Type: 80,
                    ...
                    Heading: 356.7289f,
                    InteriorPosition: new Vector4(-850f, 3440f + 245f, -180f, 10.7366f),
                    Doors: new DoorInfo[]
                    {
                    ...
                    Lights: new LightInfo[][]
                    {
                        ...
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(4.969859f, 239.3361f, -0.218224f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(-2.635627f, 239.8996f, -0.218224f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(1.801483f, 251.0864f, -0.2182245f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(5.23355f, 249.9244f, -0.2182245f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(4.926069f, 242.2638f, -0.2182242f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(1.140518f, 250.7868f, 3.081782f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(-2.784307f, 249.9406f, 3.081782f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(-2.745191f, 244.9624f, 3.081782f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(-2.710855f, 239.9792f, 3.081782f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(4.610734f, 240.6396f, 3.081782f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(4.77532f, 249.9269f, 3.081782f))
                        },
                    },
                    SupportedHouseTypes: new HashSet<HouseBase.Types>()
                    {
                ...
                new Style(Type: 90,
                    ...
                    Heading: 89.03065f,
                    InteriorPosition: new Vector4(-850f, 3440f + 280f, -180f, 9.00488f),
                    Doors: new DoorInfo[]
                    {
                    ...
                    Lights: new LightInfo[][]
                    {
                        ...
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_7_0", new Vector3(-3.993486f, 274.6962f, 1.70866f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_7_0", new Vector3(3.686812f, 281.8657f, 1.70866f))
                        },
                    },
                    SupportedHouseTypes: new HashSet<HouseBase.Types>()
                    {
                ...
                new Style(Type: 100,
                    ...
                    Heading: 81.4196f,
                    InteriorPosition: new Vector4(-850f, 3440f + 315f, -180f, 9.42834f),
                    Doors: new DoorInfo[]
                    {
                    ...
                    Lights: new LightInfo[][]
                    {
                        ...
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_1_0", new Vector3(-3.677651f, 314.9938f, 1.693291f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_1_0", new Vector3(3.751418f, 309.8597f, 1.693291f))
                        },

                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_7_0", new Vector3(-4.760465f, 309.9926f, 1.68866f))
                        },
                    },
                    SupportedHouseTypes: new HashSet<HouseBase.Types>()
                    {
                ...
                new Style(Type: 110,
                    ...
                    Heading: 83.89639f,
                    InteriorPosition: new Vector4(-850f, 3440f + 350f, -180f, 10.0227f),
                    Doors: new DoorInfo[]
                    {
                    ...
                    Lights: new LightInfo[][]
                    {
                        ...
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_1_0", new Vector3(3.813694f, 355.0768f, 1.698292f))
                        },
                        new LightInfo[]
                        {
                        ...
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_7_0", new Vector3(-5.114809f, 354.458f, 1.703661f))
                        },
                    },
                    SupportedHouseTypes: new HashSet<HouseBase.Types>()
                    {
                ...
                new Style(Type: 120,
                    ...
                    Heading: 269.9142f,
                    InteriorPosition: new Vector4(-850f, 3440f + 385f, -180f, 12.0572f),
                    Doors: new DoorInfo[]
                    {
                    ...
                    Lights: new LightInfo[][]
                    {
                        ...
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_7_0", new Vector3(0.6668818f, 381.1875f, -0.1913468f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_7_0", new Vector3(0.6495017f, 378.3827f, -0.1913468f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_7_0", new Vector3(-1.485061f, 380.1133f, -0.1913468f))
                        },

                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_1_0", new Vector3(-0.5480608f, 390.4648f, 3.405036f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_1_0", new Vector3(3.86345f, 390.0189f, 3.405036f))
                        ...
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_1_0", new Vector3(-0.3946362f, 390.4435f, -0.1950091f))
                        },
                    },
                    SupportedHouseTypes: new HashSet<HouseBase.Types>()
                    {
                ...
                new Style(Type: 130,
                    ...
                    Heading: 87.02471f,
                    InteriorPosition: new Vector4(-850f, 3440f + 420f, -180f, 12.1327f),
                    Doors: new DoorInfo[]
                    {
                    ...
                    Lights: new LightInfo[][]
                    {
                        ...
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_1_0", new Vector3(5.325827f, 418.4982f, 1.564584f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_1_0", new Vector3(0.5055502f, 413.9978f, 1.564584f))
                        },
                    },
                    SupportedHouseTypes: new HashSet<HouseBase.Types>()
                    {
                ...
                new Style(Type: 140,
                    ...
                    Heading: 271.9679f,
                    InteriorPosition: new Vector4(-850f, 3440f + 455f, -180f, 13.569f),
                    Doors: new DoorInfo[]
                    {
                    ...
                    Lights: new LightInfo[][]
                    {
                        ...
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_7_0", new Vector3(-3.836375f, 457.7079f, 3.687751f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_7_0", new Vector3(-3.84143f, 454.6393f, 3.687751f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_7_0", new Vector3(-6.735017f, 456.1489f, 3.307752f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_1_0", new Vector3(-2.642789f, 456.0628f, 0.09237802f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_1_0", new Vector3(1.765093f, 456.4812f, 0.09237779f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_1_0", new Vector3(5.769177f, 462.0398f, 0.09237779f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_1_0", new Vector3(-2.553523f, 450.0591f, 0.09237802f))
                        },
                    },
                    SupportedHouseTypes: new HashSet<HouseBase.Types>()
                    {
                ...
                new Style(Type: 150,
                    ...
                    Heading: 269.0663f,
                    InteriorPosition: new Vector4(-850f, 3440f + 490f, -180f, 14.7842f),
                    Doors: new DoorInfo[]
                    {
                        new DoorInfo("apa_p_mp_yacht_door_01", new Vector3(-0.3869764f, 459.239f, 1.554612f)),
                    ...
                    Lights: new LightInfo[][]
                    {
                        ...
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_7_0", new Vector3(-1.245679f, 489.4554f, -0.2163407f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_7_0", new Vector3(-3.635203f, 492.3578f, -0.2163407f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_7_0", new Vector3(-1.216342f, 489.2183f, 3.383641f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_1_0", new Vector3(-4.622376f, 497.2843f, -0.2117097f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_1_0", new Vector3(0.1963161f, 497.8428f, 3.388272f))
                        },
                    },
                    SupportedHouseTypes: new HashSet<HouseBase.Types>()
                    {
                ...
                new Style(Type: 160,
                    ...
                    Heading: 269.621f,
                    InteriorPosition: new Vector4(-850f, 3440f + 525f, -180f, 16.2984f),
                    Doors: new DoorInfo[]
                    {
                    ...
                    Lights: new LightInfo[][]
                    {
                        ...
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_1_0", new Vector3(-3.17395f, 516.8767f, 4.538254f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_1_0", new Vector3(0.6622602f, 526.7348f, 0.7517968f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_1_0", new Vector3(1.283101f, 526.8842f, 4.35181f))
                        },

                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_1_0", new Vector3(-0.09641814f, 530.6565f, 0.7417971f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_7_0", new Vector3(-5.79264f, 524.5608f, 4.347178f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_7_0", new Vector3(3.472058f, 532.0806f, 0.747166f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_7_0", new Vector3(-6.451055f, 524.6136f, 0.747166f))
                        },
                    },
                    SupportedHouseTypes: new HashSet<HouseBase.Types>()
                    {
                ...
                new Style(Type: 1010,
                    ...
                    Heading: 265.6042f,
                    InteriorPosition: new Vector4(-900f, 3440f, -180f, 7.09981f),
                    Doors: new DoorInfo[]
                    {
                    ...
                    Lights: new LightInfo[][]
                    {
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(-2.263044f, 3.407688f, 1.481788f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(1.42442f, -2.815429f, 1.491786f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(1.551695f, 2.69418f, 1.491788f))
                        },
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(-2.263044f, -0.5923127f, 1.481788f))
                        },
                    },
                    SupportedHouseTypes: new HashSet<HouseBase.Types>()
                    {
                        HouseBase.Types.Apartments,
                    },
                    SupportedRoomTypes: new HashSet<RoomTypes>()
                    {
                        RoomTypes.Two,
                ...
                new Style(Type: 1020,
                    ...
                    Heading: 265.2024f,
                    InteriorPosition: new Vector4(-900f, 3440f + 35f, -180f, 7.360031f),
                    Doors: new DoorInfo[]
                    {
                    ...
                    Lights: new LightInfo[][]
                    {
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_3_1", new Vector3(-2.497479f, 36.39978f, 1.491785f))
                        },
                        ...
                        new LightInfo[]
                        {
                            new LightInfo("brp_p_light_5_0", new Vector3(-2.482678f, 39.65707f, 1.495396f))
                        },
                    },
                    SupportedHouseTypes: new HashSet<HouseBase.Types>()
                    {
                ...
                new Style(Type: 1030,
                    ...
                    Heading: 265.8553f,
                    InteriorPosition: new Vector4(-900f, 3440f + 70f, -180f, 7.91285f),
                    Doors: new DoorInfo[]
                    {
                ...
                new Style(Type: 1040,
                    ...
                    Heading: 267.7038f,
                    InteriorPosition: new Vector4(-900f, 3440f + 105f, -180f, 9.25402f),
                    Doors: new DoorInfo[]
                    {
                ...
                new Style(Type: 1050,
                    ...
                    Heading: 265.9755f,
                    InteriorPosition: new Vector4(-900f, 3440f + 140f, -180f, 10.4071f),
                    Doors: new DoorInfo[]
                    {
                ...
                new Style(Type: 1060,
                    ...
                    Heading: 272.7087f,
                    InteriorPosition: new Vector4(-900f, 3440f + 175f, -180f, 11.1925f),
                    Doors: new DoorInfo[]
                    {
                ...
                new Style(Type: 1070,
                    ...
                    Heading: 268.0993f,
                    InteriorPosition: new Vector4(-900f, 3440f + 210f, -180f, 10.7189f),
                    Doors: new DoorInfo[]
                    {
...
/*						new LightInfo[]
                ...
                (Type: 1080,
                    ...
                    Heading: 268.7205f,
                    InteriorPosition: new Vector4(-900f, 3440f + 245f, -180f, 11.213f),
                    Doors: new DoorInfo[]
                    {
                ...
                new Style(Type: 1090,
                    ...
                    Heading: 263.868f,
                    InteriorPosition: new Vector4(-900f, 3440f + 280f, -180f, 12.3893f),
                    Doors: new DoorInfo[]
                    {
                ...
                {
                    lines.Add(
                        $"new Style({x.Key}, {x.Value.Position.ToCSharpStr()}, {x.Value.InteriorPosition.ToCSharpStr()}, {x.Value.Price}, \"{x.Value.Doors.SerializeToJson().Replace('\"', '\'')}\", \"{x.Value.Lights.SerializeToJson().Replace('\"', '\'')}\", \"{x.Value.SupportedRoomTypes.SerializeToJson().Replace('\"', '\'')}\", \"{x.Value.SupportedHouseTypes.SerializeToJson().Replace('\"', '\'')}\", \"{x.Value.FamiliarTypes.SerializeToJson().Replace('\"', '\'')}\");"
                    );
                }

                Utils.FillFileToReplaceRegion(Directory.GetCurrentDirectory() + Properties.Settings.Static.ClientScriptsTargetPath + @"\Game\Estates\Core.cs",
                    "STYLES_TO_REPLACE",
                    lines
                );
            }
