...
namespace BlaineRP.Server.Game.Achievements
{
    public partial class Achievement
    {
        ...
        {
            { AchievementType.SR1, new Data(80, Gift.Prototype.CreateAchievement(GiftTypes.Money, null, 0, 10_000)) },
            { AchievementType.SR2, new Data(100, Gift.Prototype.CreateAchievement(GiftTypes.Money, null, 0, 10_000)) },
        };
