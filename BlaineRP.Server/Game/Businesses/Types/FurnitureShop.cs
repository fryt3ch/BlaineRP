...
{
    public partial class FurnitureShop : Shop
    {
        public static BusinessType DefaultType => BusinessType.FurnitureShop;
        ...
        public FurnitureShop(int ID, Vector3 PositionInfo, Vector4 PositionInteract) : base(ID, PositionInfo, PositionInteract, DefaultType)
        {
        }
        ...
        public override bool TryBuyItem(PlayerData pData, bool useCash, string itemId)
        {
            ...
            var furn = new Estates.Furniture(itemId);
