...
namespace BlaineRP.Server.Game.Businesses
{
    public abstract class VehicleShop : Shop, IEnterable
    {
        ...
        public VehicleShop(int ID, Vector3 PositionInfo, Utils.Vector4 EnterProperties, BusinessTypes Type, Utils.Vector4[] AfterBuyPositions, Utils.Vector4 PositionInteract) : base(ID, PositionInfo, PositionInteract, Type)
        {
        ...
        public override bool TryBuyItem(PlayerData pData, bool useCash, string itemId)
        {
            ...
            if (Type >= BusinessTypes.CarShop1 && Type <= BusinessTypes.CarShop3)
            {
                if (!pData.HasLicense(LicenseTypes.B))
                    return false;
            }
            else if (Type == BusinessTypes.MotoShop)
            {
                if (!pData.HasLicense(LicenseTypes.A))
                    return false;
            }
            else if (Type == BusinessTypes.BoatShop)
            {
                if (!pData.HasLicense(LicenseTypes.Sea))
                    return false;
            }
            else if (Type == BusinessTypes.AeroShop)
            {
                if (!pData.HasLicense(LicenseTypes.Fly))
                    return false;
            }
    ...
    {
        public static BusinessTypes DefaultType => BusinessTypes.CarShop1;
    ...
    {
        public static BusinessTypes DefaultType => BusinessTypes.CarShop2;
    ...
    {
        public static BusinessTypes DefaultType => BusinessTypes.CarShop3;
    ...
    {
        public static BusinessTypes DefaultType => BusinessTypes.MotoShop;
    ...
    {
        public static BusinessTypes DefaultType => BusinessTypes.BoatShop;
    ...
    {
        public static BusinessTypes DefaultType => BusinessTypes.AeroShop;
