...
{
    [Offer(OfferType.EmsMedicalCard)]
    internal class EmsMedicalCard : OfferBase
    {
        public override void OnAccept(PlayerData pData, PlayerData tData, Offer offer)
        {
            ...
            MedicalCard.DiagnoseTypes diagType = MedicalCard.GetPlayerDiagnose(tData);

            var curTime = Utils.GetCurrentTime();

            var medicalCard = new MedicalCard(curTime, pData.Info, diagType);
