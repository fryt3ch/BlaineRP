...
namespace BlaineRP.Server.Game.Fractions
{
    public abstract partial class Fraction
    {
        public static int InitializeAll()
        {
            ...
            new Police(FractionTypes.COP_BLAINE, Language.Strings.Get("FRACTION_COP_BLAINE_NAME"))
            {
            ...
            new Police(FractionTypes.COP_LS, Language.Strings.Get("FRACTION_COP_LS_NAME"))
            {
                SpawnPositions = new Utils.Vector4[]
                {
            ...
            new WeazelNews(FractionTypes.MEDIA_LS, Language.Strings.Get("FRACTION_MEDIA_LS_NAME"))
            {
                SpawnPositions = new Utils.Vector4[]
                {
            ...
            new EMS(FractionTypes.EMS_BLAINE, Language.Strings.Get("FRACTION_EMS_BLAINE_NAME"))
            {
                SpawnPositions = new Utils.Vector4[]
                {
            ...
            new EMS(FractionTypes.EMS_LS, Language.Strings.Get("FRACTION_EMS_LS_NAME"))
            {
                SpawnPositions = new Utils.Vector4[]
                {
            ...
            new Government(FractionTypes.GOV_LS, Language.Strings.Get("FRACTION_GOV_LS_NAME"))
            {
                SpawnPositions = new Utils.Vector4[]
                {
            ...
            new FIB(FractionTypes.FIB_LS, Language.Strings.Get("FRACTION_FIB_LS_NAME"))
            {
                SpawnPositions = new Utils.Vector4[]
    {
                ...
                LockerRoomPositions = new Vector3[]
    {
            ...
            new Prison(FractionTypes.PRISON_BB, Language.Strings.Get("FRACTION_PRISON_BB_NAME"))
            {
                SpawnPositions = new Utils.Vector4[]
                {
            ...
            new Army(FractionTypes.ARMY_FZ, Language.Strings.Get("FRACTION_ARMY_FZ_NAME"))
            {
                SpawnPositions = new Utils.Vector4[]
                {
            ...
            new Gang(FractionTypes.GANG_MARA, Language.Strings.Get("FRACTION_GANG_MARA_NAME"))
            {
                SpawnPositions = new Utils.Vector4[]
                {
            ...
            new Gang(FractionTypes.GANG_FAMS, Language.Strings.Get("FRACTION_GANG_FAMS_NAME"))
            {
                SpawnPositions = new Utils.Vector4[]
                {
            ...
            new Gang(FractionTypes.GANG_BALS, Language.Strings.Get("FRACTION_GANG_BALS_NAME"))
            {
                SpawnPositions = new Utils.Vector4[]
                {
            ...
            new Gang(FractionTypes.GANG_VAGS, Language.Strings.Get("FRACTION_GANG_VAGS_NAME"))
            {
                SpawnPositions = new Utils.Vector4[]
                {
            ...
            new Mafia(FractionTypes.MAFIA_ITALY, Language.Strings.Get("FRACTION_MAFIA_ITA_NAME"))
            {
                SpawnPositions = new Utils.Vector4[]
                {
            ...
            new Mafia(FractionTypes.MAFIA_RUSSIA, Language.Strings.Get("FRACTION_MAFIA_RUS_NAME"))
            {
                SpawnPositions = new Utils.Vector4[]
                {
            ...
            new Mafia(FractionTypes.MAFIA_JAPAN, Language.Strings.Get("FRACTION_MAFIA_JAP_NAME"))
            {
                SpawnPositions = new Utils.Vector4[]
                {
            ...
            Events.NPC.NPC.AddNpc($"cop0_{(int)Game.Fractions.FractionTypes.COP_BLAINE}", new Vector3(-448.2888f, 6012.634f, 31.71635f)); // cop0_1
        ...
        public static void PostInitializeAll()
        {
            ...
            {
                if (x.OwnerType == FractionTypes.None)
                    continue;
