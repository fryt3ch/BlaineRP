...
namespace BlaineRP.Server.Sync
{
    public class Report
    {
        ...
        public static Report GetByStarterPlayer(PlayerData.PlayerInfo pInfo) => AllReports.Where(x => x.StarterPlayer == pInfo).FirstOrDefault();

        public static Report GetByWorkerAdmin(PlayerData.PlayerInfo pInfo) => AllReports.Where(x => x.WorkerAdmin == pInfo).FirstOrDefault();
        ...
        public PlayerData.PlayerInfo StarterPlayer { get; private set; }

        public PlayerData.PlayerInfo WorkerAdmin { get; private set; }

        public DateTime UpdatedTime { get; private set; }

        public DateTime StarterPlayerLastSent { get; set; }

        private Dictionary<PlayerData.PlayerInfo, List<string>> ChatHistory { get; set; }

        public Report(PlayerData.PlayerInfo StarterPlayer, string StartMessage)
        {
            this.StarterPlayer = StarterPlayer;

            this.UpdatedTime = Utils.GetCurrentTime();

            this.ChatHistory = new Dictionary<PlayerData.PlayerInfo, List<string>>();
