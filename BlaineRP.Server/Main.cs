...
namespace BlaineRP.Server
{
    public class Main : Script
    {
        ...
        public static void OnResourceStart()
        {
            ...
            var clientLangResManager = new ResourceManager(typeof(BlaineRP.Client.Properties.Language).FullName, clientAssembly);
            ...
            Utils.FillFileToReplaceRegion(currentDir + Properties.Settings.Static.ClientScriptsTargetPath + @"\Main.cs", "SCRIPTS_TO_REPLACE", clientScripts);
