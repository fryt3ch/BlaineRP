    ...
    public static partial class Locale
    {
        ...
        (
            Texts: new (string Key, string Value)[]
            {
                ...
                ("POLICE_PSEARCH_L_O_1", "Предметы (руки)"),
                ("POLICE_PSEARCH_L_O_2", "Предметы (карманы)"),
                ("POLICE_PSEARCH_L_O_3", "Предметы (сумка)"),
                ("POLICE_PSEARCH_L_O_4", "Предметы (кобура)"),
                ...
                ("POLICE_PSEARCH_E_0", "У этого человека нет такого документа!"),
                ("POLICE_PSEARCH_E_1", "Не найдено ни одного потенциально нелегального предмета!"),
                ("POLICE_PSEARCH_E_2", "У этого человека нет сумки!"),
                ("POLICE_PSEARCH_E_3", "У этого человека нет кобуры!"),
                ("POLICE_PSEARCH_C_0", "{0} конфисковал у Вас {1}!"),
