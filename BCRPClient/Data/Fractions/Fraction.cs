...
namespace BCRPClient.Data.Fractions
{
    ...
    public abstract class Fraction
    {
        ...
        private static Dictionary<uint, string> PermissionNames = new Dictionary<uint, string>()
        {
            ...
            { 1, "Доступ к верстаку создания предметов (даже если закрыто)" },
            { 2, "Приглашать новых сотрудников" },
            { 3, "Повышать/понижать сотрудников в должности" },
            { 4, "Увольнять сотрудников сотрудников" },
            { 5, "Респавнить фракционный транспорт" },
            { 6, "Использовать чат фракции" },

            { 7, "Использовать чат департамента" },

            { 8, "Заключать в Следственный изолятор" },
            { 9, "Выпускать из Следственного изолятора" },
            { 10, "Изменять время заключения (только для Следственного изолятора)" },

            { 11, "Заключать в Федеральную тюрьму" },

            { 12, "Штрафовать" },
            { 13, "Лишать лицензии (кроме адвокатской и на право владения бизнесом)" },
        };
