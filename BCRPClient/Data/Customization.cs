...
{
    public class Customization : Events.Script
    {
        #region Classes
        ...
        private static Dictionary<int, int> MaleHairs;
        private static Dictionary<int, int> FemaleHairs;

        private static List<HairOverlay> MaleHairOverlays;
        private static List<HairOverlay> FemaleHairOverlays;

        private static Dictionary<int, int> MaleDefaultHairOverlays;
        private static Dictionary<int, int> FemaleDefaultHairOverlays;
        ...
        {
            #region All Hairs
            MaleHairs = new Dictionary<int, int>()
            {
                // GTA Default
            ...
            FemaleHairs = new Dictionary<int, int>()
            {
                // GTA Default
            ...
            #region All Hair Overlays
            MaleHairOverlays = new List<HairOverlay>()
            {
                null, // 0
            ...
            FemaleHairOverlays = new List<HairOverlay>()
            {
                null,
            ...
            #region Default Hair Overlays
            MaleDefaultHairOverlays = new Dictionary<int, int>()
            {
                {0,  0},
                {1,  2},
                {2,  3},
            ...
            FemaleDefaultHairOverlays = new Dictionary<int, int>()
            {
                {0,  0},
                {1,  2},
                {2,  3},
