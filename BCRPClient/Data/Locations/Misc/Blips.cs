...
namespace BCRPClient.Data
{
    public partial class Locations
    {
        ...
        {
            new Blip(60, new Vector3(-444f, 6016f, 0f), Fractions.Fraction.Get(Fractions.Types.BCPD)?.Name ?? Fractions.Types.BCPD.ToString(), 1f, 63, 255, 0f, true, 0, 0f, Settings.MAIN_DIMENSION);
            new Blip(60, new Vector3(441.9979f, -983.1353f, 0f), Fractions.Fraction.Get(Fractions.Types.LSPD)?.Name ?? Fractions.Types.LSPD.ToString(), 1f, 63, 255, 0f, true, 0, 0f, Settings.MAIN_DIMENSION);
            ...
            new Blip(744, new Vector3(-598.7835f, -929.9023f, 0f), Fractions.Fraction.Get(Fractions.Types.WZLN)?.Name ?? Fractions.Types.WZLN.ToString(), 1f, 1, 255, 0f, true, 0, 0f, Settings.MAIN_DIMENSION);

            new Blip(61, new Vector3(-253.3461f, 6333.604f, 0f), Fractions.Fraction.Get(Fractions.Types.BCEMS)?.Name ?? Fractions.Types.BCEMS.ToString(), 1f, 1, 255, 0f, true, 0, 0f, Settings.MAIN_DIMENSION);
            new Blip(61, new Vector3(304.3673f, -586.6595f, 0f), Fractions.Fraction.Get(Fractions.Types.LSEMS)?.Name ?? Fractions.Types.LSEMS.ToString(), 1f, 1, 255, 0f, true, 0, 0f, Settings.MAIN_DIMENSION);
            ...
            new Blip(419, new Vector3(-548.8925f, -197.5878f, 0f), Fractions.Fraction.Get(Fractions.Types.LSADM)?.Name ?? Fractions.Types.LSADM.ToString(), 1f, 0, 255, 0f, true, 0, 0f, Settings.MAIN_DIMENSION);
