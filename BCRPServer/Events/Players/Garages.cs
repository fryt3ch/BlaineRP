...
namespace BCRPServer.Events.Players
{
    class Garages : Script
    {
        ...
        public static void GarageExit(Player player)
        {
            ...
            player.Teleport(garage.Root.EnterPosition.Position, false, Settings.CurrentProfile.Game.MainDimension, garage.Root.EnterPosition.RotationZ, true);
        ...
        private static void GarageSlotsMenu(Player player, Vehicle veh, uint gRootId)
        {
            ...
            if (player.Dimension != Settings.CurrentProfile.Game.MainDimension || !vData.IsFullOwner(pData))
                return;
