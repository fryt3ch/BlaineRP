    ...
    public class Furniture
    {
        ...
        public class ItemData
        {
            ...
            public static int LoadAll()
            {
                ...
                new ItemData("furn_188", Types.KitchenSet, "Кухонный гарнитур полный Белый прямой", "brp_p_furn_kitchen_1");
                ...
                new ItemData("furn_191", Types.KitchenSet, "Кухонный гарнитур полный Черный прямой", "brp_p_furn_kitchen_12");
                new ItemData("furn_192", Types.KitchenSet, "Остров кухонный профессиональный темный", "brp_p_furn_kitchen_13");
                new ItemData("furn_193", Types.KitchenSet, "Кухонный гарнитур полный угловой белый с черным", "brp_p_furn_kitchen_14");
                ...
                new ItemData("furn_198", Types.KitchenSet, "Кухонный гарнитур полный Черный прямой с деревом", "brp_p_furn_kitchen_19");
                new ItemData("furn_199", Types.Locker, "Антресоль белая с боковым шкафом (L)", "brp_p_furn_kitchen_2");
                new ItemData("furn_200", Types.KitchenSet, "Остров кухонный профессиональный светлый", "brp_p_furn_kitchen_20");
