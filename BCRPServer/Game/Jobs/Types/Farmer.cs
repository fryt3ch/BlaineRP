    ...
    public class Farmer : Job, IVehicles
    {
        ...
        public override void Initialize()
        {
            ...
            if (subId == 0)
            {
                ...
                Vehicles.Add(VehicleData.NewJob(Id, numberplate, tractorType, tractorCol1, tractorCol2, new Utils.Vector4(1865.232f, 4872.092f, 44.38249f, 206.4608f), Properties.Settings.Profile.Current.Game.MainDimension));
                Vehicles.Add(VehicleData.NewJob(Id, numberplate, tractorType, tractorCol1, tractorCol2, new Utils.Vector4(1870.744f, 4874.888f, 44.66641f, 206.8733f), Properties.Settings.Profile.Current.Game.MainDimension));
                Vehicles.Add(VehicleData.NewJob(Id, numberplate, tractorType, tractorCol1, tractorCol2, new Utils.Vector4(1876.944f, 4878.157f, 45.11294f, 202.0746f), Properties.Settings.Profile.Current.Game.MainDimension));
                Vehicles.Add(VehicleData.NewJob(Id, numberplate, tractorType, tractorCol1, tractorCol2, new Utils.Vector4(1859.166f, 4868.78f, 44.17879f, 210.0185f), Properties.Settings.Profile.Current.Game.MainDimension));

                Vehicles.Add(VehicleData.NewJob(Id, numberplate, planeType, tractorCol1, tractorCol2, new Utils.Vector4(2143.947f, 4813.993f, 41.57311f, 114.3835f), Properties.Settings.Profile.Current.Game.MainDimension));
            }
