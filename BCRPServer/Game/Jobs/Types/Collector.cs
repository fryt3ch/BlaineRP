    ...
    public class Collector : Job, IVehicles
    {
        ...
        public override void Initialize()
        {
            ...
            if (subId == 0)
            {
                ...
                Vehicles.Add(VehicleData.NewJob(Id, numberplateText, vType, colour1, colour2, new Utils.Vector4(-125.2996f, 6476.03f, 31.06822f, 134.7541f), Settings.MAIN_DIMENSION));
                Vehicles.Add(VehicleData.NewJob(Id, numberplateText, vType, colour1, colour2, new Utils.Vector4(-128.2522f, 6479.262f, 31.07171f, 134.5773f), Settings.MAIN_DIMENSION));
            }
            else if (subId == 1)
            {
                var colour1 = new Utils.Colour(255, 255, 255, 255);
                ...
                Vehicles.Add(VehicleData.NewJob(Id, numberplateText, vType, colour1, colour2, new Utils.Vector4(162.2404f, -1081.599f, 28.79756f, 1.330183f), Settings.MAIN_DIMENSION));
                Vehicles.Add(VehicleData.NewJob(Id, numberplateText, vType, colour1, colour2, new Utils.Vector4(158.5186f, -1081.227f, 28.79802f, 1.025265f), Settings.MAIN_DIMENSION));
                Vehicles.Add(VehicleData.NewJob(Id, numberplateText, vType, colour1, colour2, new Utils.Vector4(154.839f, -1081.596f, 28.79737f, 1.333282f), Settings.MAIN_DIMENSION));
                Vehicles.Add(VehicleData.NewJob(Id, numberplateText, vType, colour1, colour2, new Utils.Vector4(150.9679f, -1081.523f, 28.79806f, 1f), Settings.MAIN_DIMENSION));
                Vehicles.Add(VehicleData.NewJob(Id, numberplateText, vType, colour1, colour2, new Utils.Vector4(147.2328f, -1081.582f, 28.79786f, 1f), Settings.MAIN_DIMENSION));
                Vehicles.Add(VehicleData.NewJob(Id, numberplateText, vType, colour1, colour2, new Utils.Vector4(143.5911f, -1081.642f, 28.79869f, 1f), Settings.MAIN_DIMENSION));
                Vehicles.Add(VehicleData.NewJob(Id, numberplateText, vType, colour1, colour2, new Utils.Vector4(139.8136f, -1081.303f, 28.7997f, 1f), Settings.MAIN_DIMENSION));
            }
        }
