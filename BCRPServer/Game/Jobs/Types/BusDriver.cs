    ...
    public class BusDriver : Job, IVehicles
    {
        ...
        public override void Initialize()
        {
            if (SubId == 0)
            {
                ...
                Vehicles.Add(VehicleData.NewJob(Id, numberplateText, vType, colour1, colour2, new Utils.Vector4(-766.2029f, 5524.796f, 34.31338f, 28.3842f), Utils.Dimensions.Main));
                Vehicles.Add(VehicleData.NewJob(Id, numberplateText, vType, colour1, colour2, new Utils.Vector4(-762.9031f, 5526.446f, 34.31443f, 29.5885f), Utils.Dimensions.Main));
                Vehicles.Add(VehicleData.NewJob(Id, numberplateText, vType, colour1, colour2, new Utils.Vector4(-759.7948f, 5528.181f, 34.31483f, 30.55079f), Utils.Dimensions.Main));
                Vehicles.Add(VehicleData.NewJob(Id, numberplateText, vType, colour1, colour2, new Utils.Vector4(-756.5928f, 5529.695f, 34.31594f, 29.94526f), Utils.Dimensions.Main));
                Vehicles.Add(VehicleData.NewJob(Id, numberplateText, vType, colour1, colour2, new Utils.Vector4(-753.6445f, 5532.07f, 34.31636f, 29.10272f), Utils.Dimensions.Main));
                Vehicles.Add(VehicleData.NewJob(Id, numberplateText, vType, colour1, colour2, new Utils.Vector4(-750.3279f, 5533.969f, 34.31674f, 29.43421f), Utils.Dimensions.Main));
            }
            else
            {
